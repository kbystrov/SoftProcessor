...
const int ERR_LAB_TAB_RLC_RLC_LAB = 36;

//! Error code: negative input for SQRT command
const int ERR_NEG_SQRT = 37;
//! Error code: troubles with scanf in IN command
const int ERR_PROC_SCNF_IN = 38;

//! Error code: input processor is nullptr in ProcessorCTor(Processor ** processor, char * filename)
const int ERR_PROC_CTOR_NULL = 39;
//! Error code: input filename pointer is nullptr in ProcessorCTor(Processor ** processor, char * filename)
const int ERR_PROC_CTOR_FLNM = 40;

//! Error code: input processor is nullptr in ProcessorDTor(Processor * processor)
const int ERR_PROC_DTOR_NULL = 41;
