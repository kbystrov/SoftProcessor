...
CMD_DEF(SUB, 4, StackPush(stk, ( - StackPop(stk,&err_code) ) + StackPop(stk,&err_code)); instr_ptr++)
CMD_DEF(MUL, 5, StackPush(stk, StackPop(stk,&err_code) * StackPop(stk,&err_code)); instr_ptr++)
CMD_DEF(DIV, 6, StackPush(stk, StackPop(stk,&err_code) / StackPop(stk,&err_code)); instr_ptr++)
